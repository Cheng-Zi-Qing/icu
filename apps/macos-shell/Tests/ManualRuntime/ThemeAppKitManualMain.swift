...
struct ThemeAppKitManualMain {
    ...
    static func main() throws {
        ...
        do {
            ...
            try testReminderCardBodyWinsHitTestingOverTransparentPetPixels()
            try testReminderCardAcceptsFirstMouseWhenWindowIsInactive()
            ...
            try testHealthReportWindowRendersHydrationReminderMetrics()
            try testReminderCompleteAndSkipLogExpectedOutcomes()
            try testReminderPresentationExpandsWindowAndKeepsCardAbovePetCanvas()
            try testWorkStateBubbleExpandsWindowAndKeepsBubbleAbovePetCanvas()
            ...
            try testDesktopPetViewRoutesOpaquePetHitsToSelfForDragging()
            try testDesktopPetViewRoutesStatusChipHitsToSelfForDragging()
            try testDesktopPetViewAcceptsFirstMouseForDesktopDragging()
            try testDesktopPetWindowAllowsBackgroundDragging()
